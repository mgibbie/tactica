...
export class SkillTargetingService {
    ...
    public setupSkillTargeting(
        ...
        // For Bandage, Outburst, Star Song, Symphony, Staccato, and Terraform skills, auto-execute immediately without targeting
        if (skill.id === 'bandage' || skill.id === 'outburst' || skill.id === 'star-song' || skill.id === 'symphony' || skill.id === 'staccato' || skill.id === 'terraform') {
