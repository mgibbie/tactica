...
export class SkillTargetingService {
    ...
    public setupSkillTargeting(
        ...
        if (skill.targetingType === 'non-rotational' && (skill.id === 'blazing-knuckle' || skill.id === 'healing-circle' || skill.id === 'flash-of-sun')) {
            ...
            if (skill.id === 'stars-blessing' || skill.id === 'aethers-grace' || skill.id === 'exhaust' || skill.id === 'jeer' || skill.id === 'hype-up' || skill.id === 'steady-beat' || skill.id === 'switcheroo' || skill.id === 'smoke-grenade' || skill.id === 'distraction' || skill.id === 'toxic-king' || skill.id === 'psyche-break') {
                uiManager.showSkillConfirmCancelButtons(
                    skill.name,
                    onConfirm,
                    onCancel
    ...
    public handleSkillTargetSelection(
        ...
        if (skill?.targetingType === 'dual-rotational') {
            ...
            // Special handling for skills that don't need rotation (like Exhaust, Jeer, Distraction, Hype Up, Steady Beat, Switcheroo, Star's Blessing, Toxic King, Psyche Break)
            if (skill.id === 'exhaust' || skill.id === 'jeer' || skill.id === 'distraction' || skill.id === 'hype-up' || skill.id === 'steady-beat' || skill.id === 'switcheroo' || skill.id === 'smoke-grenade' || skill.id === 'stars-blessing' || skill.id === 'toxic-king' || skill.id === 'psyche-break') {
