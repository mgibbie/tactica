...
export class SkillTargetingService {
    ...
    public setupSkillTargeting(
        ...
        if (skill.targetingType === 'non-rotational' && (skill.id === 'blazing-knuckle' || skill.id === 'healing-circle' || skill.id === 'flash-of-sun' || skill.id === 'tidal-lock')) {
            ...
            if (skill.id === 'stars-blessing' || skill.id === 'aethers-grace' || skill.id === 'exhaust' || skill.id === 'jeer' || skill.id === 'hype-up' || skill.id === 'inspire-violence' || skill.id === 'mirror-aegis' || skill.id === 'steady-beat' || skill.id === 'peace-sign' || skill.id === 'idolize' || skill.id === 'switcheroo' || skill.id === 'smoke-grenade' || skill.id === 'distraction' || skill.id === 'toxic-king' || skill.id === 'psyche-break' || skill.id === 'flare-up' || skill.id === 'cauterize') {
                uiManager.showSkillConfirmCancelButtons(
                    skill.name,
                    onConfirm,
                    onCancel
    ...
    public handleSkillTargetSelection(
        ...
        if (skill?.targetingType === 'dual-rotational') {
            ...
            // Special handling for skills that don't need rotation (like Exhaust, Jeer, Distraction, Hype Up, Inspire Violence, Mirror Aegis, Peace Sign, Steady Beat, Switcheroo, Star's Blessing, Toxic King, Psyche Break, Flare Up, Cauterize)
            if (skill.id === 'exhaust' || skill.id === 'jeer' || skill.id === 'distraction' || skill.id === 'hype-up' || skill.id === 'inspire-violence' || skill.id === 'mirror-aegis' || skill.id === 'peace-sign' || skill.id === 'steady-beat' || skill.id === 'switcheroo' || skill.id === 'smoke-grenade' || skill.id === 'stars-blessing' || skill.id === 'toxic-king' || skill.id === 'psyche-break' || skill.id === 'flare-up' || skill.id === 'cauterize') {
