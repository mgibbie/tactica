...
export class GamePhaseManager {
            ...
            () => {
                ...
                if (result) {
                    ...
                    affectedUnits.forEach((affectedUnit: Unit) => {
                        ...
                        const isNonDamageBuff = skill.id === 'exhaust' || skill.id === 'prepare' || skill.id === 'jeer' || skill.id === 'distraction' || skill.id === 'back-off' || skill.id === 'psyche-break' || skill.id === 'hype-up' || skill.id === 'steady-beat' || skill.id === 'rescue' || skill.id === 'get-sturdy' || skill.id === 'taunt' || skill.id === 'switcheroo' || skill.id === 'stars-blessing';
    ...
    private isSelfTargetingSkill(skill: Skill, unit: Unit, unitRenderer: any): boolean {
        ...
        if (skill.id === 'teleport' || skill.id === 'lead-the-charge' || skill.id === 'bounce' || skill.id === 'spring-slash' || skill.id === 'teleport-slash' || skill.id === 'dizzy-slam') {
            return false;
        }
