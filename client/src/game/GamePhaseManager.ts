            ...
            () => {
                ...
                if (result) {
                    ...
                    affectedUnits.forEach((affectedUnit: Unit) => {
                        ...
                        const isNonDamageBuff = skill.id === 'exhaust' || skill.id === 'prepare' || skill.id === 'zero-in' || skill.id === 'tracking-dart' || skill.id === 'flashbang' || skill.id === 'jeer' || skill.id === 'distraction' || skill.id === 'back-off' || skill.id === 'psyche-break' || skill.id === 'hype-up' || skill.id === 'steady-beat' || skill.id === 'rescue' || skill.id === 'get-sturdy' || skill.id === 'taunt' || skill.id === 'switcheroo' || skill.id === 'stars-blessing';
