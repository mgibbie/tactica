...
export class GamePhaseManager {
            ...
            () => {
                ...
                if (result) {
                    ...
                    affectedUnits.forEach((affectedUnit: Unit) => {
                        ...
                        const isNonDamageBuff = skill.id === 'exhaust' || skill.id === 'prepare' || skill.id === 'zero-in' || skill.id === 'tracking-dart' || skill.id === 'flashbang' || skill.id === 'hunker-down' || skill.id === 'jeer' || skill.id === 'distraction' || skill.id === 'back-off' || skill.id === 'psyche-break' || skill.id === 'hype-up' || skill.id === 'steady-beat' || skill.id === 'rescue' || skill.id === 'get-sturdy' || skill.id === 'taunt' || skill.id === 'switcheroo' || skill.id === 'stars-blessing' || skill.id === 'the-wall' || skill.id === 'reflect' || skill.id === 'primal-mark' || skill.id === 'terraform' || skill.id === 'mirrormancy' || skill.id === 'turret-line';
    ...
    private isSelfTargetingSkill(skill: Skill, unit: Unit, unitRenderer: any): boolean {
        ...
        // Airstrike is a global effect; do not consider it self-targeting
        if (skill.id === 'airstrike') {
            return false;
        }
