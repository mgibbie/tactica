...
export class GameScene {
    ...
    public async confirmSkill(): Promise<void> {
        ...
        affectedUnits.forEach((unit) => {
            ...
            if (currentSkill) {
                const isHealing = currentSkill.id === 'universal-whisper' || currentSkill.id === 'healing-circle' || currentSkill.id === 'bandage' || currentSkill.id === 'finger-of-god' || currentSkill.id === 'star-song';
