    ...
    public async confirmSkill(): Promise<void> {
        ...
        affectedUnits.forEach((unit) => {
            ...
            if (currentSkill) {
                ...
                const isDebuff = currentSkill.id === 'exhaust' || currentSkill.id === 'prepare' || currentSkill.id === 'zero-in' || currentSkill.id === 'tracking-dart' || currentSkill.id === 'flashbang' || currentSkill.id === 'hunker-down' || currentSkill.id === 'jeer' || currentSkill.id === 'distraction' || currentSkill.id === 'back-off' || currentSkill.id === 'psyche-break' || currentSkill.id === 'hype-up' || currentSkill.id === 'steady-beat' || currentSkill.id === 'rescue' || currentSkill.id === 'get-sturdy' || currentSkill.id === 'taunt' || currentSkill.id === 'switcheroo' || currentSkill.id === 'flare-up';
